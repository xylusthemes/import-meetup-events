            ...
            <div class="iee-support-features">
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon" src="<?php echo IEE_PLUGIN_URL.'assets/images/document.svg'; ?>" alt="<?php esc_attr_e( 'Looking for Something?', 'import-meetup-events' ); ?>">
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Looking for Something?', 'import-meetup-events' ); ?></h3>
				...
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon" src="<?php echo IEE_PLUGIN_URL.'assets/images/call-center.svg'; ?>" alt="<?php esc_attr_e( 'Need Any Assistance?', 'import-meetup-events' ); ?>">
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Need Any Assistance?', 'import-meetup-events' ); ?></h3>
				...
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon"  src="<?php echo IEE_PLUGIN_URL.'assets/images/bug.svg'; ?>" alt="<?php esc_attr_e( 'Found Any Bugs?', 'import-meetup-events' ); ?>" />
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Found Any Bugs?', 'import-meetup-events' ); ?></h3>
				...
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon" src="<?php echo IEE_PLUGIN_URL.'assets/images/tools.svg'; ?>" alt="<?php esc_attr_e( 'Require Customization?', 'import-meetup-events' ); ?>" />
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Require Customization?', 'import-meetup-events' ); ?></h3>
				...
				<div class="iee-support-features-card">
					<div class="iee-support-features-img">
						<img class="iee-support-features-icon" src="<?php echo IEE_PLUGIN_URL.'assets/images/like.svg'; ?>" alt="<?php esc_attr_e( 'Like The Plugin?', 'import-meetup-events' ); ?>" />
					</div>
					<div class="iee-support-features-text">
						<h3 class="iee-support-features-title"><?php esc_attr_e( 'Like The Plugin?', 'import-meetup-events' ); ?></h3>
