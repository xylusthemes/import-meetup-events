<div class="ime-wizard-wrap" >
    <h3><?php esc_attr_e( 'Import Meetup Event', 'import-meetup-events' ); ?></h3>
    <div class="ime-wizard-starter-video" >
        <a id="ime-watch-video-btn" href="javascript:void(0)" class="ime-wizard-button-style">
            ...
            <p><?php esc_attr_e( 'Getting Started Video', 'import-meetup-events' ); ?></p>
        </a>
    </div>
    ...
    <div class="ime-wizard-open-popup-box" >
        ...
        <button class="ime-wizard-open-popup ime-settings ime-wizard-button-style" id="ime_wizard_setting_button" onclick="window.location.href='<?php echo esc_url( admin_url( 'admin.php?page=meetup_import&tab=settings' ) ); ?>';" >
            ...
            <span><?php esc_attr_e( 'Settings', 'import-meetup-events' ); ?></span>
        </button>
        <div style="clear:both" ></div>
    </div>

    <div class="ime-wizard-back-box" >
        <button class="ime-wizard-back-button">
            ...
            <span onclick="window.location.href='<?php echo esc_url( admin_url( 'admin.php?page=meetup_import&tab=dashboard' ) ); ?>';" ><?php esc_attr_e( 'Back to WordPress Dashboard', 'import-meetup-events' ); ?></span>
        </button>
    </div>
    <a href="admin.php?page=meetup_import&tab=dashboard" title="close" class="ime-wizard-close-button">
...
<div id="ime-wizard-video-popup" class="ime-popup-overlay">
    <div class="ime-popup-content">
        <span id="ime-wizard-close-popup" class="ime-close-btn">&times;</span>
        <iframe id="ime-wizard-video-frame" width="1350" height="700" src="" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    </div>
</div>