 ...
 */
    class Import_Meetup_Events {
        ...
        public function __clone() {
            _doing_it_wrong(__FUNCTION__, __('Cheatin&#8217; huh?', 'import-meetup-events'), '1.5.2');
        }
        ...
        private function setup_constants() {
            ...
            if (!defined('IME_VERSION')) {
                define('IME_VERSION', '1.5.2');
            }

            // Minimum Pro plugin version.
            if( ! defined( 'IME_MIN_PRO_VERSION' ) ){
                define( 'IME_MIN_PRO_VERSION', '1.5.1' );
            }
        ...
        private function includes() {
            ...
            require_once IME_PLUGIN_DIR . 'includes/libs/Parsedown.php';
            // Gutenberg Block
